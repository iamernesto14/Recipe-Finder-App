...
const FilterMenu = ({ isOpen, onClose }) => {
  return (
    <div
      className={`fixed top-0 right-0 w-[350px] h-full bg-white dark:bg-main-800 shadow-lg transform ${
    ...
    >
      ...
      {/* Search Input */}
      <div className="mx-2 pl-3 flex gap-1 items-center justify-center border border-black">
        <LuSearch className="" />
        <input
          type="text"
          placeholder="Search recipe..."
          className="w-full px-2 py-2 outline-none focus:outline-none dark:bg-main-700 dark:border-main-600 dark:text-main-100"
        />
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full flex justify-between items-center gap-4 p-4 bg-white dark:bg-main-800 border-t border-gray-200">
