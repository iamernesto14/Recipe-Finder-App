    ...
    <div>
      ...
      <div className="p-4 mt-24">
        ...
        <div className="flex justify-between items-center gap-10">
          <h1 className="text-[26px] leading-7 font-bold mb-4">{recipe.label}</h1>
        ...
        <div className="flex items-center justify-evenly my-10">
          <div className="flex items-center flex-col justify-center">
            <p className="text-3xl font-semibold">{recipe.ingredients[0]?.quantity || 0}</p>
            <p>Ingredients</p>
          </div>
          <div className="w-[2px] h-14 bg-main-900"></div>
          <div className="flex items-center flex-col justify-center">
            <p className="text-3xl font-semibold">{recipe.totalTime || 0}</p>
            <p>Minutes</p>
          </div>
          <div className="w-[2px] h-14 bg-main-900"></div>
          <div className="flex items-center flex-col justify-center">
            <p className="text-3xl font-semibold">{recipe.calories?.toFixed(2) || "0.00"}</p>
            <p>Calories</p>
          </div>
        </div>
