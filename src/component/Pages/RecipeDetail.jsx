...
function RecipeDetail() {
  ...
  return (
    <div className="dark:bg-main-900">
      <Header />
      <div className="p-4 mt-8 dark:bg-main-900 dark:text-main-100">
        <div>
          ...
          <button
            onClick={() => navigate(-1)}
            className="inline-block mt-10 mb-6 bg-main-100 dark:bg-main-600 py-2 px-6 rounded shadow-[0_0_5px_rgba(0,0,0,0.3)] text-gray-700 dark:text-main-100 hover:bg-main-200 transition-all duration-200"
          >
            &larr; Back
          </button>
          <img
        ...
        <p className="text-[12px] text-main-400">by {recipe.source || "Unknown"}</p>
